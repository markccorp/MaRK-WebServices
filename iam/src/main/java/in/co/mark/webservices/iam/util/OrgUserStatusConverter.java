...
/**
 * JPA {@link AttributeConverter} for the {@link OrgUserStatus} {@code enum}.
 * <p>
 * This converter enables automatic persistence and retrieval of
 * {@code OrgUserStatus} {@code enum} constants based on their associated
 ...
 */
@Converter
public class OrgUserStatusConverter extends IntValuedEnumConverter<OrgUserStatus> {

	/**
	 * Constructs a converter for the {@link OrgUserStatus} {@code enum}.
	 */
	public OrgUserStatusConverter() {
		super(OrgUserStatus.class);
	}
}
