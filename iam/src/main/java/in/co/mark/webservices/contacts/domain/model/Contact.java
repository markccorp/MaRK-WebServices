...
/**
 * Represents a <i>contact</i>.
 * <p/>
 * Note:
 * <ul>
 * <li>A contact can either be an <i>Org Contact</i> or <i>Personal
 * contact</i></li>
 * <li>By default all Org users will be added as Org contacts</li>
 * <li>An Org Admin can add additional Org contacts</li>
 * <li>Normal users can add only personal contacts</li>
 * </ul>
 */
public class Contact extends OwnerSpecificModelBase {
	/**
	 ...
	 *                      updated
	 */
	public Contact(long ownerId, boolean isOwnerOrg, String firstName, String middleName, String lastName,
			String nickName, boolean isFav, long createdOn, long lastUpdatedOn) {
		super(ownerId);
	 ...
	 *                        updated
	 */
	public Contact(long id, long ownerId, boolean isOwnerOrg, int namePrefixId, String initial, String firstName,
			String middleName, String lastName, String nickName, int nameSuffixId, String gender, int dobDate,
			int dobMonth, int dobYear, String avatarUri, int maritalStatusId, int marriageDate, int marriageMonth,
			int marriageYear, long spouseContactId, String spouseName, boolean isFav, long createdOn,
			long lastUpdatedOn) {
