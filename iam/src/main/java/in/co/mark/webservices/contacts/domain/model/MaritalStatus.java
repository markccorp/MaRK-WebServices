...
public class MaritalStatus extends OwnerSpecificModelBase {
	/**
	...
	/**
	 * Initializes {@code ownerId}, {@code maritalStatus}, and {@code desc}
	 * properties of this instance
	 * 
	 * @param ownerId       ID of the owner - can be a user or an organization
	 * @param maritalStatus Marital status value of this instance
	 * @param desc          Description of this marital status
	 */
	public MaritalStatus(long ownerId, String maritalStatus, String desc) {
		super(ownerId);
	...
	/**
	 * Initializes {@code ownerId}, {@code isOwnerOrg}, {@code maritalStatus}, and
	 ...
	 * @param desc          Description of this marital status
	 */
	public MaritalStatus(long ownerId, boolean isOwnerOrg, String maritalStatus, String desc) {
		super(ownerId);
	 ...
	 *                      last updated
	 */
	public MaritalStatus(long id, long ownerId, boolean isOwnerOrg, String maritalStatus, String desc, long createdOn,
			long lastUpdatedOn) {
	...
	/**
	 * To get the marital status value
	 * 
	 * @return {@code maritalStatus} value
	 */
	...
	/**
	 * To set a marital status value
	 * 
	 * @param maritalStatus A marital status value
	 */
	...
	/**
	 * To get the description of this marital status
	 * 
	...
	/**
	 * To set the description of this marital status
	 * 
	 * @param desc Description of this marital status
	 */
